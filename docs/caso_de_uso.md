...
Un **estudiante o investigador** inicia un trabajo sobre el uso de IA Generativa en determinada área de conocimiento (ciencias de la salud, finanzas, marketing, negocios... ). Y necesita escribir el **capítulo del estado del arte** de su TFG, TFM o paper.
...
Este sistema **no pretende** representar el estado del arte global de la IA Generativa. Trabaja sobre un corpus acotado seleccionado por el usuario. Las conclusiones que se extraen son **locales al corpus** y no extrapolables al ecosistema mundial.
