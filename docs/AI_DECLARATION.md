...
|---|---|---|
| **Claude** | Anthropic | Asistente conversacional para redacción y código. |
...
- Esqueletos de los scripts del pipeline.
- Generación de `docker-compose.yml` para levantar la app.

## Tareas que NO se han hecho con IA

- **Decisión final** sobre el caso de uso, el stack de fuentes y la estructura de la ontologia: tomada por el grupo después de discutir las opciones.
...
2. **Editados** cuando el contenido no encajaba con la realidad del trabajo, era genérico o contenía errores.
...
4. **Aprobados** por consenso del grupo antes de la entrega final.

**Ningún fragmento se ha incluido sin revisión.**
